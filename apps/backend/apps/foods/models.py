...
class Food(models.Model):
    ...
    recommended_for_supplements = models.JSONField(default=list, blank=True)
    nutrient_tags = models.JSONField(default=list, blank=True)
    synergy_reason = models.TextField(blank=True)
    avoid_or_caution = models.TextField(blank=True)
    allergen_tags = models.JSONField(default=list, blank=True)
    diet_tags = models.JSONField(default=list, blank=True)
    association_rule_items = models.JSONField(default=list, blank=True)

...
- Serve the active hybrid recommender endpoints:
  - `GET /api/v1/recommendations/foods/?n=10`
  - `POST /api/v1/recommendations/preview/`
  - `POST /api/v1/recommendations/generate/`
- Train reusable recommendation artifacts with `python manage.py train_recommender`

Hybrid scoring:

```txt
CBF = 0.35*objective + 0.40*medical + 0.15*supplement + 0.10*calorie
Final = alpha*CBF + beta*AssociationRules + gamma*CollaborativeFiltering
```
  ...
  "items": [
    {
      ...
      "explanation": "Orange matches your nutrition profile and complements your supplements.",
      "tags": ["vitamine_c"],
      "warnings": []
    }
  ]
